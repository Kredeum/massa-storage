  ...
  <tr>
    ...
    {#each columns as column}
      <th
        ...
        style="width: {column.key === 'name' ? '25%' : column.key === 'tags' || column.key === 'lastModified' ? '15%' : column.key === null ? '13%' : '8%'}"
      >
        <button
    ...
    <th scope="col" class="w-[8%] px-4 py-3 text-center text-xs font-medium uppercase tracking-wider text-gray-500"> Actions </th>
  </tr>
</thead>
